    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-r from-blue-900 to-blue-700 text-white py-20">
        <div className="container mx-auto text-center px-4">
          ...
          <p className="text-xl mb-8">Where friends share, chat, and connect</p>
          <div className="mb-8">
            <p className="text-lg opacity-90 mb-4">"We believe social connections should be beautiful, secure, and meaningful."</p>
            <div>
